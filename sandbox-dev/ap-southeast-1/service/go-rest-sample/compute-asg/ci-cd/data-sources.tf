locals {
  ...
  packer_binary   = "https://releases.hashicorp.com/packer/1.9.2/packer_1.9.2_linux_amd64.zip"
  ami_filename    = "ami_result.txt"
  ...
  remote_state_key_app         = "ap-southeast-1/service/go-rest-sample/compute-asg/app/terraform.tfstate"
